...
app.get('/', function (req, res){
    const url = "http://api.openweathermap.org/data/2.5/weather?id=1260086&appid=31f2772c8481253024098bda0bad3b76&units=metric"
    http.get(url, function(responce) {
        ...
        responce.on('data', function(data) {
            ...
            res.write("<h1>The Temperature in Patna is "+ weatherTemp +" degrees celsius</h1>");
